...
• search for attributes <b><keyword></b>`
  ...
  const docsURLBtn = `View <button id='url-button' class='menu-button' style='color: var(--main-tx-color); background-color: var(--main-bg-color); width: 45px; height: 25px;'>docs</button>`
